    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <h1 class="text-xs-center">MathOps Quiz : Custom</h1>
        ...
        <div class="text-md-center">
            <router-link to="/startPageCustom">
...
<script>
    ...
    import startPageCustom from './quizCustom/startPageCustom.vue';
    import QuestionCustom from './quizCustom/QuestionCustom.vue';
    import AnswerCustom from './quizCustom/AnswerCustom.vue';
    import wrongAnswerCustom from './quizCustom/wrongAnswerCustom.vue';
    ...
    export default {
        ...
        components: {
            appQuestion: QuestionCustom,
            appAnswer: AnswerCustom,
            appWrongAnswer: wrongAnswerCustom
        }
    }
</script>
