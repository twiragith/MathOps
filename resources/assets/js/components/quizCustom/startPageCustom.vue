    ...
    <v-flex xs12 sm6 offset-sm3>
      <v-card>
        <v-layout align-center justify-center>
            <v-card-title >
            <div>
                <h3 class="text-xs-center">you are about to face a mathOps <strong class="red--text text--lighten-1">custom</strong>  quiz...</h3>
            </div>
            </v-card-title>
        </v-layout>
        <v-layout align-center justify-center>
            <v-card-actions >
                <v-container fluid>
                    <v-radio-group v-model="column" column>
                        <v-radio label="test your skills with multiple operators" value="radio-1"></v-radio>
                        <v-radio label="test your skill on a single operator" value="radio-2"></v-radio>
                    </v-radio-group>
                </v-container>
            </v-card-actions>
        </v-layout>
